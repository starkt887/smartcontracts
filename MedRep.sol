...
contract MedRep {
    ...
    function createTCollect(string memory title, string memory symbol)
        external
    {
        MediRecords digiReps = new MediRecords(
            title,
            symbol,
            msg.sender,
            address(this)
    ...
    function getAllMediRecords() external view returns (MediRecords[] memory) {
        return allDigiRepss;
    }
...
contract MediRecords is ERC721URIStorage, ERC721Holder {
